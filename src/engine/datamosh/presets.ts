...
export const DATAMOSH_PRESETS: DatamoshPreset[] = [
  ...
  },
  {
    id: 'color-bloom',
    label: 'Color Bloom',
    description: 'Màu sắc loang lổ và nhòe dần theo chuyển động, tạo hiệu ứng mộng mị.',
    relevant: ['intensity', 'persistence', 'decay', 'smearLength', 'blend'],
    params: {
      intensity: 120,
      motion: 40,
      stretch: 80,
  ...
  },
  {
    id: 'liquid-melt',
    label: 'Liquid Melt',
    description: 'Hình ảnh tan chảy như chất lỏng, biến dạng mạnh theo hướng cố định.',
    relevant: ['persistence', 'decay', 'smearLength', 'direction', 'motion'],
    params: {
      persistence: 95,
      decay: 8,
      smearLength: 80,
  ...
  {
    id: 'aggressive-stutter',
    label: 'Aggressive Stutter',
    description: 'Giật khung hình liên tục kèm theo nhiễu hạt nặng và méo âm thanh.',
    relevant: ['repeatCount', 'holdFrames', 'corruption', 'randomness', 'audioAmount'],
    params: {
      holdFrames: 4,
      repeatCount: 5,
      persistence: 60,
  ...
  },
  {
    id: 'pixel-burst',
    label: 'Pixel Burst',
    description: 'Hình ảnh vỡ vụn thành các khối pixel lớn và nhảy ngẫu nhiên.',
    relevant: ['skipAmount', 'skipPattern', 'blockSize', 'corruption', 'randomness'],
    params: {
      skipAmount: 3,
      skipPattern: 'random',
      blockSize: '16',
